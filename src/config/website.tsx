...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/langrisserseaofsword/hero.jpg',
      logoLight: '/langrisserseaofsword/logo.png',
      logoDark: '/langrisserseaofsword/logo.png',
    },
    social: {
      github: '',
      twitter: 'https://x.com/LLSeaofswordEN',
      blueSky: '',
      discord: 'https://discord.gg/Wukgzve6kb',
      mastodon: '',
      linkedin: '',
      youtube: 'https://www.youtube.com/@LangrisserSeaofswordEN',
    },
  },
  features: {
  ...
  mail: {
    provider: 'resend',
    fromEmail:
      'Langrisser: Sea of Sword Wiki <hello@langrisserseaofsword.wiki>',
