...
export function Footer({ className }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <footer
      className={cn(
        'border-[#39505a] border-t bg-[#061119] text-[#f5efe1]',
        className
      )}
    >
      ...
      <div className="border-[#39505a] border-t py-8">
        <Container className="px-4 flex items-center justify-between gap-x-4">
          ...
          <span className="text-muted-foreground text-sm">
            Independent guide hub. Not affiliated with Black Jack Studio,
            HongKong GameTree Limited, Valve, Steam or YouTube.
          </span>
        </Container>
      </div>
    </footer>
