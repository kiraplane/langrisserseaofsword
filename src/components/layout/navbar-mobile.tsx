    ...
    <>
      ...
      >
        ...
        >
          ...
          <span className="hidden truncate font-semibold sm:inline sm:text-xl">
            {t('Metadata.name')}
          </span>
        </LocaleLink>
        ...
        <div className="ml-2 flex shrink-0 items-center justify-end">
          <Button
            ...
            className="size-8 flex aspect-square h-fit cursor-pointer select-none items-center
              justify-center rounded-md border border-[#39505a] text-[#f5efe1] hover:border-[#6ed2c5] hover:bg-[#17303a]"
          >
            {open ? (
...
function MainMobileMenu({ onLinkClicked }: MainMobileMenuProps) {
  ...
  return (
    <div
      ...
      border-[#39505a] border-t bg-[#061119] text-[#f5efe1] backdrop-blur-md animate-in fade-in-0"
    >
      <div className="size-full flex flex-col items-start space-y-4 pt-4">
                ...
                {item.items ? (
                    ...
                    <CollapsibleTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          ...
                          'bg-transparent text-[#aebcb8] cursor-pointer',
                          'hover:bg-transparent hover:text-[#d8b060]',
                          'focus:bg-transparent focus:text-[#d8b060]',
                          isActive &&
                            'font-semibold bg-transparent text-[#d8b060]'
                        )}
                      >
                            ...
                            <li key={subItem.title}>
                              ...
                              >
                                ...
                                {subItem.external && (
                                  <ArrowUpRightIcon
                                    className={cn(
                                      'size-4 shrink-0 text-[#aebcb8] items-center',
                                      'group-hover:bg-transparent group-hover:text-[#d8b060]',
                                      'group-focus:bg-transparent group-focus:text-[#d8b060]',
                                      isSubItemActive &&
                                        'bg-transparent text-[#d8b060]'
                  ...
                  <LocaleLink
                    ...
                    className={cn(
                      ...
                      'hover:bg-transparent hover:text-[#d8b060]',
                      'focus:bg-transparent focus:text-[#d8b060]',
                      isActive && 'font-semibold bg-transparent text-[#d8b060]'
                    )}
                    onClick={onLinkClicked}
                  >
        ...
        {/* bottom buttons */}
        <div className="flex w-full items-center justify-center gap-4 border-[#39505a]/70 border-t p-4">
          <LocaleSelector />
        </div>
      </div>
    </div>
