...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: 'Cookie Policy | Langrisser: Sea of Sword Wiki',
    description:
      'How Langrisser: Sea of Sword Wiki uses essential cookies and analytics.',
    locale,
    pathname: '/cookie',
  });
}
    ...
    <div className="bg-[#07131b] py-12 text-[#f5efe1]">
      <Container className="max-w-3xl space-y-6 px-4">
        ...
        <p className="leading-8 text-[#aebcb8]">
          Langrisser: Sea of Sword Wiki uses essential cookies and similar
